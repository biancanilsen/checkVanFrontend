...
class AppPalette {
  ...
  static const Color neutral70 = Color(0xFFFDFDFD);
  ...
  static const Color green75 = Color(0xFFE0E6E0);
  ...
  static const Color yellow100 = Color(0xFFFFF2C0);
  static const Color yellow200 = Color(0xFFFFC532);
  ...
  static ThemeData get theme {
    ...
    return baseTheme.copyWith(
      ...
      inputDecorationTheme: InputDecorationTheme(
        isDense: true, // Garante inputs mais compactos
        contentPadding: const EdgeInsets.symmetric(vertical: 12, horizontal: 12), // Padding ajustado
        filled: true,
        fillColor: AppPalette.neutral75,

        // Estilo padrão do Hint
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: AppPalette.neutral900, width: 1.0),
        ),
