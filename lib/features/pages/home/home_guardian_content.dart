// Salve como: /lib/features/pages/home/guardian_home_content.dart
...
class GuardianHomeContent extends StatefulWidget {
  const GuardianHomeContent({super.key});

  @override
  State<GuardianHomeContent> createState() => _GuardianHomeContentState();
}

class _GuardianHomeContentState extends State<GuardianHomeContent> {
  ...
  Widget build(BuildContext context) {
    ...
    // Note: O Scaffold e o BottomNavBar foram removidos.
    // Começamos com o SafeArea.
    return SafeArea(
